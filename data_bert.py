...
class FlickrDataset(data.Dataset):
    ...
    def __init__(self, root, json, split, tokenizer, feature_path=None, region_bbox_file=None, max_seq_len=32,
        ...
        self.grid_feature_path = '/home/ubuntu/data/f30k/'
        self.grid_feature_path1 = '/home/ubuntu/data/f30k/grid_features/'
    ...
    def __getitem__(self, index):
        ...
        return img_rcnn, img_grid, img_mask, img_box, target, index, img_id, image_orig
...
def collate_fn(data):
    img_rcnn, img_grid, img_mask, img_box, captions, ids, img_ids, image_orig = zip(*data)
    ...
    return img_rcnn, img_grid, img_mask, img_box, captions, ids
