...
def main():
    ...
    parser.add_argument('--bert_path', default='/home/ubuntu/DSRAN/DSRAN_bert/uncased_L-12_H-768_A-12/',
    ...
    parser.add_argument('--feature_path', default='/home/ubuntu/data/f30k_precomp_100/region_feat_gvd_wo_bgd/trainval/',
                        type=str, help='path to the pre-computed image features')
    parser.add_argument('--region_bbox_file',
                        default='/home/ubuntu/data/f30k_precomp_100/region_feat_gvd_wo_bgd/flickr30k_detection_vg_thresh0.2_feat_gvd_checkpoint_trainvaltest.h5',
